...
public class CoeDashboardTileHandler extends IncludeHandler {

  private static final String _VIEW_ID = "/com/eproseed/coe/common/view/declcomp/CoeDashboardTile.jsf";

  public CoeDashboardTileHandler(ComponentConfig config) {
    super(config);
  }
