...
public class CoeTimePickerHandler extends IncludeHandler {

  private static final String _VIEW_ID = "/com/eproseed/coe/common/view/declcomp/CoeTimePicker.jsf";

  public CoeTimePickerHandler(ComponentConfig config) {
    super(config);
  }
