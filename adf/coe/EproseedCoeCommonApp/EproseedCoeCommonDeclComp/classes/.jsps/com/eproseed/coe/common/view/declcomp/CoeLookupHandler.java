...
public class CoeLookupHandler extends IncludeHandler {

  private static final String _VIEW_ID = "/com/eproseed/coe/common/view/declcomp/CoeLookup.jsf";

  public CoeLookupHandler(ComponentConfig config) {
    super(config);
  }
