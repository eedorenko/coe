package com.eproseed.coe.common.view.utils;
...
public class ADFUtils {
    ...
    public static List<SelectItem> selectItemsForIterator(String iteratorName, String valueAttrName,
        ...
        return selectItemsForIterator(findIterator(iteratorName), valueAttrName, displayAttrNames);
    }
    ...
    public static List<Map<String, Object>> attributeListForIterator(String iteratorName, String[] attrNames) {
        return attributesListForIterator(findIterator(iteratorName), attrNames);
    }
    ...
    public static Map<Object, Object> attributeMapForIterator(String iteratorName, String keyAttrName,
                                                              String valueAttrName) {
        return attributesMapForIterator(findIterator(iteratorName), keyAttrName, valueAttrName);
    }
    ...
    public static void showPopup(String popupName) {
        ...
        RichPopup popup = (RichPopup) JSFUtils.findComponentInRoot(popupName);
        popup.show(ph);
    }

    public static boolean isExceptionInBindingContainer(String errorCode) {
        if (errorCode != null) {
            DCBindingContainer bindingContainer = (DCBindingContainer) ADFUtils.getBindingContainer();
            if (bindingContainer != null) {
                List<Exception> exceptionList = bindingContainer.getExceptionsList();
                if (exceptionList != null) {
                    for (Exception ex : exceptionList) {
                        if (ex instanceof JboException) {
                            if (errorCode.equals(((JboException) ex).getErrorCode())) {
                                return true;
                            }
    ...
    public static void partialRefresh(UIComponent component) {
        if (component!=null) {
            AdfFacesContext.getCurrentInstance().addPartialTarget(component);            
        }        
    }
    
    public static BindingContainer findBindingContainerByPath(String path) {
        BindingContext bc = BindingContext.getCurrent();
        return bc.findBindingContainerByPath(path);
    }
